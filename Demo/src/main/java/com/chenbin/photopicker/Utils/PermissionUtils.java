package com.chenbin.photopicker.Utils;
...
public class PermissionUtils {
    ...
    public static void getPermission(Activity activity) {
        ...
        checkNotification(activity);    //通知权限
        for (String permission : permissions) {
            if ((ContextCompat.checkSelfPermission(activity.getApplicationContext(), permission))
                    != PackageManager.PERMISSION_GRANTED) {
//                if(isFirst){
//                    isFirst = false;
//                    ClauseDialog clauseDialog = new ClauseDialog(activity);
//                    clauseDialog.getTextView_sure().setOnClickListener(view -> {
